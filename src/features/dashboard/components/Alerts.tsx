  ...
  return (
    <div className="flex gap-3 py-3 border-b border-slate-50 last:border-0 group cursor-pointer hover:bg-[#F7F8F4] -mx-1 px-1 rounded-[10px] transition-colors">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[12px] text-[#444441] leading-relaxed line-clamp-2">
          {message}
        </p>
      </div>
    </div>
...
export const AlertsSection = ({ className }: { className?: string }) => {
  return (
    <div className={cn("bg-white border border-slate-100 rounded-2xl p-7 flex flex-col h-full", className)}>
      ...
      {/* Legend */}
      <div className="flex items-center gap-4 mb-4 pb-3 border-b border-slate-50">
        <span className="flex items-center gap-1.5 text-[10px] font-semibold text-[#B0AFA8]">
          <span className="w-2 h-2 rounded-full bg-[#E63535] flex-shrink-0" />Urgent
        </span>
        <span className="flex items-center gap-1.5 text-[10px] font-semibold text-[#B0AFA8]">
          <span className="w-2 h-2 rounded-full bg-[#EF9800] flex-shrink-0" />Notice
        </span>
        <span className="flex items-center gap-1.5 text-[10px] font-semibold text-[#B0AFA8]">
          <span className="w-2 h-2 rounded-full bg-[#2E77F4] flex-shrink-0" />Info
        </span>
      </div>
