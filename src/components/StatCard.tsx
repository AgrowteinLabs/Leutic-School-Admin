...
export const StatCard = ({
    ...
    return (
        <div className="flex items-center gap-4 rounded-2xl px-5 py-4 bg-white border border-slate-100 transition-shadow group relative z-10 hover:z-20">
            <div className={cn(
                ...
                <div className="flex items-center gap-1">
                    ...
                    {tooltip && (
                        <div className="relative group/tooltip">
                            ...
                            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-48 p-2 bg-[#152328] text-white text-[10px] rounded-lg opacity-0 group-hover/tooltip:opacity-100 transition-opacity pointer-events-none z-[100]">
                                {tooltip}
